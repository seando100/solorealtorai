  ...
  if (!post) {
    return (
      <div className="max-w-4xl mx-auto px-6 py-20 text-center">
        ...
        <Link to="/blog" className="text-blue-600 hover:underline">{t('blog.backToBlogLink')}</Link>
      </div>
    );
  }
    ...
    <div>
      ...
      <article className="max-w-3xl mx-auto px-6 py-12">
        <div
          ...
          dangerouslySetInnerHTML={{ __html: (isEs && post.contentEs) || post.content }}
        />
      </article>
      ...
      <section className="max-w-3xl mx-auto px-6 pb-16">
        <div className="bg-[#0F2745] rounded-2xl p-8 md:p-12 text-center">
          ...
          <p className="text-gray-300 mb-6">{t('blog.ctaBody')}</p>
